...
// import { useDeleteEmployeeMutation, useGetEmployeesQuery, useRestoreEmployeeMutation } from '@/redux/apis/admin.api'
...
//     const [employeeRestore] = useRestoreEmployeeMutation()
...
//                     <div className="card">
//                         <div className="card-header text-center">Employee Register</div>
//                         <div className="card-body">
//                             <form onSubmit={handleSubmit(handleRegister)}>
//                                 <div>
//                                     <input {...register("name")} type="text" placeholder='Enter Name' className={handleClasses("name")} />
//                                     <div className='invalid-feedback'>{errors && errors.name?.message}</div>
//                                 </div>

//                                 <div>
//                                     <input {...register("email")} type="text" placeholder='email@example.com' className={handleClasses("email")} />
//                                     <div className='invalid-feedback'>{errors && errors.email?.message}</div>
//                                 </div>

//                                 <div>
//                                     <input {...register("mobile")} type="text" placeholder='Enter Mobile Number' className={handleClasses("mobile")} />
...
//                                     {
//                                         item.isDelete
//                                             ? <button className='btn btn-sm btn-warning' onClick={() => employeeRestore({ _id: item._id, isDelete: false })}>Restore</button>
//                                             : <div>
//                                                 <button className='btn btn-sm btn-outline-danger'>
//                                                     <i className='bi bi-pencil'></i>
//                                                 </button>

//                                                 <button onClick={() => employeeDelete({ _id: item._id, isDelete: true })} className='btn btn-sm btn-outline-warning ms-2'>
