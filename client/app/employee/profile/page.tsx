                        ...
                        <form onSubmit={handleSubmit(handleUpdate)}>
                            ...
                            <div>
                                <div className='mb-3'>
                                    ...
                                    <input {...register("mobile")} type="text" className='form-control' />
                                </div>
                                <div className="invalid-feedback"></div>
                            </div>

                            <button data-bs-dismiss="modal" type='submit' className='btn btn-warning w-100 text-white'>Update Profile</button>
                        </form>
                    </div>
                </div>
            </div>
